...
function BookReservation() {
    ...
    return (
        <>
            ...
            <p className="ml-2 mt-3 font-extrabold text-2xl">Room {roomName}</p>
            <p className="font-bold ml-2 text-md mt-1">{roomType}</p>
            <div className="rounded-md shadow-md shadow-blue-500 m-2 mt-5">
                <p className="text-2xl font-extrabold text-blue-500 text-center my-2">
                    Book
                </p>

                <form onSubmit={handleSubmit} className="flex flex-col mx-6">
